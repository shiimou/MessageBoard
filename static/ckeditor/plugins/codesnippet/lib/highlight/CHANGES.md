...
[tm]: http://jmmessage.github.com/color-themes-for-highlightjs/
...
[p]: http://softwaremaniacs.org/message/2012/05/10/http-and-json-in-highlight-js/en/
...
Developer overview of the new language syntax is available in a [message post about
recent beta release][beta].

[beta]: http://softwaremaniacs.org/message/2011/04/25/highlight-js-60-beta/en/
...
[vd]: http://dolzhenko.messagespot.com/
...
[jd]: http://jason.diamond.name/wemessage/
...
[my wife's message][alenacpp] had issues with it from time to time). And lastly
thanks go to Sam for getting rid of my stylistic comments in code that were
getting in the way of [JSMin][].

[zenburn]: http://en.wikipedia.org/wiki/Zenburn
[alenacpp]: http://alenacpp.messagespot.com/
...
[xonix]: http://xonixx.messagespot.com/
